...
public class CoinPlacement : NetworkBehaviour {
	...
	public int numSawRobots = 5;
	public GameObject coinPrefab;
	public GameObject enemyPrefab;
	public GameObject robotPrefab;
	public GameObject sawRobotPrefab;
	...
	void SpawnItemSet(GameObject obj, int numToSpawn) {
		...
		for (int i = 0; i < numToSpawn; i++) {
			while (true) {
				...
				if (rcast.collider) {
					...
					// place the coin
					GameObject enemy = Instantiate (obj, new Vector3 (pos.x, pos.y, 0), Quaternion.identity) as GameObject;
	...
	public void PlaceCoins() {
		...
		SpawnItemSet (robotPrefab, numRobots);
		SpawnItemSet (sawRobotPrefab, numSawRobots);
	}
}
